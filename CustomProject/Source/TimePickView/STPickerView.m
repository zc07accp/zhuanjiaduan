...
- (UIView *)contentView
{
    if (!_contentView) {
        ...
        [_contentView setBackgroundColor:[UIColor colorWithRed:0.93 green:0.93 blue:0.93 alpha:1.00]];
    }
    return _contentView;
}
...
- (UIButton *)buttonLeft
{
    if (!_buttonLeft) {
        ...
        [_buttonLeft setTitleColor:[UIColor colorWithRed:0.76 green:0.47 blue:0.20 alpha:1.00] forState:UIControlStateNormal];
...
- (UIButton *)buttonRight
{
    if (!_buttonRight) {
        ...
        [_buttonRight setTitleColor:[UIColor colorWithRed:0.76 green:0.47 blue:0.20 alpha:1.00] forState:UIControlStateNormal];
