...
//    [info_ drawInRect:r withFont:[UIFont systemFontOfSize:kSGInfoAlert_fontSize] lineBreakMode:UILineBreakModeTailTruncation];
    ...
    [info_ drawInRect:r withAttributes:@{@"NSFontAttributeName":[UIFont systemFontOfSize:kSGInfoAlert_fontSize],NSForegroundColorAttributeName:[UIColor whiteColor]}];
}
...
+ (void)showInfo:(NSString *)info 
    ...
    CGSize size =[info sizeWithAttributes:@{@"NSFontAttributeName":[UIFont systemFontOfSize:kSGInfoAlert_fontSize]}];
//    [info sizeWithFont:[UIFont systemFontOfSize:kSGInfoAlert_fontSize]
//                   constrainedToSize:kMax_ConstrainedSize];
    ...
    alert.center = CGPointMake(view.center.x, kMainScreen_height/3);
    alert.alpha = alpha;
