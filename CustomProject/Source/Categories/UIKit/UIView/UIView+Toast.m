...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (title != nil) {
        ...
        titleLabel.frame = CGRectMake(0.0, 0.0, kMainScreen_width*0.6, expectedSizeTitle.height);
    }
    ...
    if (message != nil) {
        ...
        messageLabel.frame = CGRectMake(0.0, 0.0, kMainScreen_width*0.6, expectedSizeMessage.height);
    }
...
//    CGFloat wrapperHeight = MAX((messageTop + messageHeight + CSToastVerticalPadding), (imageHeight + (CSToastVerticalPadding * 2)));
    ...
    wrapperView.frame = CGRectMake(0.0, 0.0, kMainScreen_width*0.6, kMainScreen_width*0.3);
